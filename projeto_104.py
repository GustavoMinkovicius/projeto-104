...
Original file is located at
    https://colab.research.google.com/drive/1wvepbsbfHaaAJP0nGpN70WtXjYSj9yzn
"""
...
new_data.sort()
if n % 2 == 0:
  mediana1 = float(new_data[n//2])
  mediana2 = float(new_data[n//2-1])
  mediana = (mediana1+mediana2)/2
else:
  mediana = new_data[n//2]
